...
import sys
import time
sys.path.append('/gdrive/My Drive/gpt2-ml-Finetune-1.0')
...
parser.add_argument(
    ...
    default='/gdrive/My Drive/gpt2-ml-Finetune-1.0/configs/mega.json',
    type=str,
...
parser.add_argument(
    '-model_ckpt',
    dest='model_ckpt',
    default='gs://gpt2-data/gpt2_1.0/model.ckpt-220000',
    type=str,
...
vocab_file_path = os.path.join(proj_root_path, "/gdrive/My Drive/gpt2-ml-Finetune-1.0/tokenization/bert-base-chinese-vocab.txt")
