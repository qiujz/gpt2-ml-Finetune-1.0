...
def main():
    ...
    parser.add_argument('--filepath', default='/data/home/share1/gpt2-ml-Finetune/data-txt', type=str, required=False, help='数据集目录地址')
    parser.add_argument('--outfile', default='/data/home/share1/gpt2-ml-Finetune/data-json/22.json', type=str, required=False,help='生成文件地址')
